        ...
        <div class="web__container">
            <div class="grid">
                <div class="grid__row-2">
                    <div class="container__title text-big-title">Tư duy & Sáng tạo</div>
                    <div class="grid__column-3">
                            ...
                            <div class="filter__box">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="video">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="live">
                        ...
                        <div class="container__filter">
                            <div class="filter__box">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="beginner">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="intermediate">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="advanced">
                        ...
                        <div class="container__filter">
                            <div class="filter__box">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="short">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="medium">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="long">
                        ...
                        <div class="container__filter">
                            <div class="filter__box">
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="short">
                                        <div class="type__text text-big">Dưới 3<i class=" text-big fa-solid fa-star" style="color: var(--yellow-color)"></i></div>
                                    </div>
                                ...
                                <div class="box__content">
                                    <div class="content__type">
                                        <input type="checkbox" class="type__checkbox text-big" value="medium">
                                        <div class="type__text text-big">Trên 3<i class=" text-big fa-solid fa-star" style="color: var(--yellow-color)"></i></div>
                                    </div>
                                    <div class="content__number text-big">28</div>
                                </div>
                            </div>
