...
(function (global, factory) {
  ...
  function conflictDetection() {
    ...
    if (testCount === 0) {
      ...
      console.info("You can adjust those durations by assigning values to these attributes on the assets/javascript/validation/form-validation.js element that loads this detection:");
