                        ...
                        <div class="user__container">
                            ...
                            <div class="user__menu">
                                <ul class="user__menu-list">
                                    ...
                                    <li class="user__menu-list-item">
                                        <a href="../html-personal-cart/order-history.html" class="turn-page">
                                            <div class="user__menu-list-item-box text-li">
                                                Lịch sử giao dịch
                                            </div>
                                        </a>
             ...
             pul           <li><div class="box__content">
                            ...
                            <div class="box__row2">
                                <div class="row2__column1-order">
                                    <span class="text"><span class="text1">Mã đơn hàng: </span>ORD101</span></div>
                                <div class="row2__column2-total">
                                    <span class="text"><span class="text1">Tổng cộng:</span> 1.796.000đ</span></div>
                                <div class="row2__column3-payment-method">
                                    <span class="text"><span class="text1">Phương thức thanh toán:</span> Momo</span></div>
                                <a href="receipt_order-history.jsp" class="turn-page">
                        ...
                        <li><div class="box__content">
                            ...
                            <div class="box__row2">
                                <div class="row2__column1-order">
                                    <span class="text"><span class="text1">Mã đơn hàng: </span>ORD101</span></div>
                                <div class="row2__column2-total">
                                    <span class="text"><span class="text1">Tổng cộng:</span> 533.100đ</span></div>
                                <div class="row2__column3-payment-method">
                                    <span class="text"><span class="text1">Phương thức thanh toán:</span> Momo</span></div>
                                <a href="receipt_order-history.jsp" class="turn-page">
                                    <div class="row2__column4-btn-receipt header__button receipt-box">
