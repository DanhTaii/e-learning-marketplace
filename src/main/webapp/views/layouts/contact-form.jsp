...
<head>
    ...
    <link rel="stylesheet" href="assets/css/base/contact-button.css?v=${applicationScope.assetVersion}">
    <link rel="stylesheet" href="assets/css/base/contact-form.css?v=${applicationScope.assetVersion}">
