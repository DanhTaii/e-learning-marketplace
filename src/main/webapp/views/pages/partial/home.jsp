        ...
        <div class="grid">
            <div class="header__box">
                ...
                <div class="header__class">
                    <a href="../../personal/course/my-course.jsp" class="turn-page text-header">
                        Khóa học của tôi
                    </a>
                </div>
                <div class="header__wishlist">
                    <a href="../../personal/course/my-wishlist.jsp" class="turn-page text-header">
                    ...
                    <div class="user__display">
                        <div class="user__container">
                            <div class="user__profile">
                                ...
                                <a href="../../personal/profile/account-profile.jsp" class="turn-page">
                            ...
                            <div class="user__menu">
                                <ul class="user__menu-list">
                                    <li class="user__menu-list-item">
                                        <a href="../../personal/course/my-course.jsp" class="turn-page">
                                    ...
                                    <li class="user__menu-list-item">
                                        <a href="../../personal/course/my-wishlist.jsp" class="turn-page">
                                            <div class="user__menu-list-item-box text-li">
                                                Yêu thích
                                            </div>
                                        </a>
                                    ...
                                    <li class="user__menu-list-item">
                                        <a href="../cart/order-history.jsp" class="turn-page">
                                            <div class="user__menu-list-item-box text-li">
                                                Lịch sử giao dịch
                                            </div>
                                        </a>
            ...
            <div class="grid__row-2">
                <div class="grid__column-3">
                    <div class="container__category">
                        <a href="all-course.jsp" class="turn-page">
                ...
                <div class="grid__colum-9">
                    <div class="container__product">
                        ...
                        <a href="course-detail.jsp" class="turn-page">
                                    ...
                                    <a href="course-detail.jsp?id=1" class="turn-page">
                                        <div class="product__small-advertisement">
                                            ...
                                            <div class="small-advertisement__content">
                                                ...
                                                <div class="text-paragraph test-text"><p>Xây Dựng Thương Hiệu Cá Nhân
                                                    Cho Bản Thân </p>
                                                </div>
                                    ...
                                    <a href="course-detail.jsp?id=1" class="turn-page">
                                        <div class="product__small-advertisement">
                                            ...
                                            <div class="small-advertisement__content">
                                                ...
                                                <div class="text-paragraph test-text"><p>Kỹ Năng Từ Chối Mà Vẫn Được Yêu
                                                    Quý</p></div>
                                                <div class="content__quick-info">
                                                    <div class="quick-info__level">
                                                        <div class="level__icon icon"><i
                                    ...
                                    <a href="course-detail.jsp?id=1" class="turn-page">
                                        <div class="product__small-advertisement">
                                            ...
                                            <div class="small-advertisement__content">
                                                ...
                                                <div class="text-paragraph test-text"><p>Lập Trình Tư Duy (Mindset
                                                    Programming)</p></div>
                                                <div class="content__quick-info">
                                                    <div class="quick-info__level">
                                                        <div class="level__icon icon"><i
