...
<head>
    ...
    <link rel="stylesheet" href="assets/css/auth/reset-password.css?v=${applicationScope.assetVersion}">
...
<script src="assets/javascript/validation/auth/reset-password.js?v=${applicationScope.assetVersion}"></script>
</html>