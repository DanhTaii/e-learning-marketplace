...
<head>
    ...
    <link rel="stylesheet"
          href="assets/css/admin/pages/order/order-management.css?v=${applicationScope.assetVersion}">
...
<script src="assets/javascript/admin/order/order-management.js?v=${applicationScope.assetVersion}"></script>
</body>
</html>