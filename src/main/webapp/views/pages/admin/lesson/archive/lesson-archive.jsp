...
<head>
    ...
    <link rel="stylesheet" href="assets/css/admin/pages/lesson/lesson-archive.css?v=${applicationScope.assetVersion}">
...
<script src="assets/javascript/admin/lesson/lesson-archive.js?v=${applicationScope.assetVersion}"></script>
</body>
