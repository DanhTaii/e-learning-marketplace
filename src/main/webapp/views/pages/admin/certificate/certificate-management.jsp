...
<head>
    ...
    <link rel="stylesheet"
          href="assets/css/admin/pages/certificate/certificate-management.css?v=${applicationScope.assetVersion}">
                    ...
                    <div class="container-2__content-body">
                        <div class="grid__row-2 container-2__grid">
                            ...
                            <div class="container-2__body">
                                <form method="get" action="admin/certificates" class="advanced-filter" id="filterForm">
                                    <script>
                                    ...
                                    <div class="filter-content" id="filterContent">
                                        <div class="filter-grid">
                                            ...
                                            <div class="filter-group">
                                                <label>Đến ngày cấp</label>
                                                <input type="date" name="toDate" value="${param.toDate}">
                                            </div>
                                        </div>
                                        <div class="filter-actions">
                                            <a href="admin/certificates" class="btn-clear">
...
<script src="assets/javascript/admin/certificate/certificate-management.js?v=${applicationScope.assetVersion}"></script>
