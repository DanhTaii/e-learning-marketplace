...
<head>
    ...
    <link rel="stylesheet" href="assets/css/admin/pages/tag/tag-management.css?v=${applicationScope.assetVersion}">
...
<script src="assets/javascript/admin/tag/tag-management.js?v=${applicationScope.assetVersion}"></script>
</body>
</html>