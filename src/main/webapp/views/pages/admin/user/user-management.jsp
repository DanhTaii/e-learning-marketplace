...
<head>
    ...
    <link rel="stylesheet"
          href="assets/css/admin/pages/user/user-management.css?v=${applicationScope.assetVersion}">
...
<script src="assets/javascript/admin/user/user-management.js?v=${applicationScope.assetVersion}"></script>
</body>
</html>