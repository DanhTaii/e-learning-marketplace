...
<input type="hidden" id="newTotalCount" value="${listUsers.size()}">
...
<%--            <th><input type="checkbox" id="selectAll"></th>--%>
        ...
        <tbody>
        <jsp:include page="/views/pages/admin/user/user-table-body.jsp"/>
        </tbody>
    </table>

<%--    <jsp:include page="/views/components/bulk-action-bar.jsp">--%>
<%--        <jsp:param name="label" value="người dùng"/>--%>
