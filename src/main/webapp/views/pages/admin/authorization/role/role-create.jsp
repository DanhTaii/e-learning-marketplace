...
<head>
    ...
    <link rel="stylesheet" href="assets/css/admin/pages/role/role-create.css?v=${applicationScope.assetVersion}">
...
<script src="assets/javascript/admin/role/role-create.js?v=${applicationScope.assetVersion}"></script>
