...
<head>
    ...
    <link rel="stylesheet" href="assets/css/admin/pages/category/category-create.css?v=${applicationScope.assetVersion}">
...
<script src="assets/javascript/admin/category/category-create.js?v=${applicationScope.assetVersion}"></script>

<%-- Javascript Validation--%>
<script src="assets/javascript/validation/admin/category-form-validation.js?v=${applicationScope.assetVersion}"></script>
