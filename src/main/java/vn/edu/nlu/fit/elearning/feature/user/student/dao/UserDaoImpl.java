...
public class UserDaoImpl extends BaseDao implements UserDao {
    ...
    public User findById(Integer integer) {
        return getJdbi().withHandle(handle -> {
            return handle.createQuery("select u.id, u.username, u.first_name AS firstName, u.last_name AS lastName, u.avatar_url, u.email, u.phone, u.status, u.created_at AS createdAt, u.updated_at AS updatedAt " +
